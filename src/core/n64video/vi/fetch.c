...
static void
vi_fetch_filter16(struct n64video_pixel *res, uint32_t fboffset, uint32_t cur_x, struct vi_reg_ctrl ctrl, uint32_t hres,
                  uint32_t fetchstate)
{
    int r, g, b;
...
static void
vi_fetch_filter32(struct n64video_pixel *res, uint32_t fboffset, uint32_t cur_x, struct vi_reg_ctrl ctrl, uint32_t hres,
                  uint32_t fetchstate)
{
    int r, g, b;
