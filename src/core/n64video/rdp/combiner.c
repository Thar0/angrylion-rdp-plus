...
set_suba_rgb_input(struct rdp_state *wstate, int32_t **input_r, int32_t **input_g, int32_t **input_b, int code)
{
    switch (code & 0xf) {
        case 0:
            *input_r = &wstate->combined_color.r;
            *input_g = &wstate->combined_color.g;
            *input_b = &wstate->combined_color.b;
            break;
        case 1:
            *input_r = &wstate->texel0_color.r;
            *input_g = &wstate->texel0_color.g;
            *input_b = &wstate->texel0_color.b;
            break;
        case 2:
            *input_r = &wstate->texel1_color.r;
            *input_g = &wstate->texel1_color.g;
            *input_b = &wstate->texel1_color.b;
            break;
        case 3:
            *input_r = &wstate->prim_color.r;
            *input_g = &wstate->prim_color.g;
            *input_b = &wstate->prim_color.b;
            break;
        case 4:
            *input_r = &wstate->shade_color.r;
            *input_g = &wstate->shade_color.g;
            *input_b = &wstate->shade_color.b;
            break;
        case 5:
            *input_r = &wstate->env_color.r;
            *input_g = &wstate->env_color.g;
            *input_b = &wstate->env_color.b;
            break;
        case 6:
            *input_r = &one_color;
            *input_g = &one_color;
            *input_b = &one_color;
            break;
        case 7:
            *input_r = &wstate->noise;
            *input_g = &wstate->noise;
            *input_b = &wstate->noise;
            break;
        case 8:
        case 9:
        case 10:
    ...
    switch (code & 0xf) {
        ...
        case 5:
            ...
            *input_b = &wstate->env_color.b;
            break;
        case 6:
            *input_r = &wstate->key_center.r;
            *input_g = &wstate->key_center.g;
            *input_b = &wstate->key_center.b;
            break;
        case 7:
            *input_r = &wstate->k4;
            *input_g = &wstate->k4;
    ...
    switch (code & 0x1f) {
        ...
        case 5:
            ...
            *input_b = &wstate->env_color.b;
            break;
        case 6:
            *input_r = &wstate->key_scale.r;
            *input_g = &wstate->key_scale.g;
            *input_b = &wstate->key_scale.b;
            break;
        case 7:
            *input_r = &wstate->combined_color.a;
            *input_g = &wstate->combined_color.a;
            *input_b = &wstate->combined_color.a;
            break;
        case 8:
            *input_r = &wstate->texel0_color.a;
            *input_g = &wstate->texel0_color.a;
            *input_b = &wstate->texel0_color.a;
            break;
        case 9:
            *input_r = &wstate->texel1_color.a;
            *input_g = &wstate->texel1_color.a;
            *input_b = &wstate->texel1_color.a;
            break;
        case 10:
            *input_r = &wstate->prim_color.a;
            *input_g = &wstate->prim_color.a;
            *input_b = &wstate->prim_color.a;
            break;
        case 11:
            *input_r = &wstate->shade_color.a;
            *input_g = &wstate->shade_color.a;
            *input_b = &wstate->shade_color.a;
            break;
        case 12:
            *input_r = &wstate->env_color.a;
            *input_g = &wstate->env_color.a;
            *input_b = &wstate->env_color.a;
            break;
        case 13:
            *input_r = &wstate->lod_frac;
            *input_g = &wstate->lod_frac;
            *input_b = &wstate->lod_frac;
            break;
        case 14:
            *input_r = &wstate->primitive_lod_frac;
            *input_g = &wstate->primitive_lod_frac;
            *input_b = &wstate->primitive_lod_frac;
            break;
        case 15:
            *input_r = &wstate->k5;
            *input_g = &wstate->k5;
...
set_sub_alpha_input(struct rdp_state *wstate, int32_t **input, int code)
{
    switch (code & 0x7) {
        case 0:
            *input = &wstate->combined_color.a;
            break;
        case 1:
            *input = &wstate->texel0_color.a;
            break;
        case 2:
            *input = &wstate->texel1_color.a;
            break;
        case 3:
            *input = &wstate->prim_color.a;
            break;
        case 4:
            *input = &wstate->shade_color.a;
            break;
        case 5:
            *input = &wstate->env_color.a;
            break;
        case 6:
            *input = &one_color;
            break;
    ...
    switch (code & 0x7) {
        ...
        case 5:
            *input = &wstate->env_color.a;
            break;
        case 6:
            *input = &wstate->primitive_lod_frac;
            break;
        case 7:
            *input = &zero_color;
            break;
...
static STRICTINLINE int32_t
alpha_combiner_equation(int32_t a, int32_t b, int32_t c, int32_t d)
{
    a = special_9bit_exttable[a];
    b = special_9bit_exttable[b];
    c = SIGNF(c, 9);
...
combiner_1cycle(struct rdp_state *wstate, int adseed, uint32_t *curpixel_cvg)
{
    ...
    if (wstate->combiner_rgbmul_r[1] != &zero_color) {
        ...
        wstate->combined_color.r =
            color_combiner_equation(*wstate->combiner_rgbsub_a_r[1], *wstate->combiner_rgbsub_b_r[1],
                                    *wstate->combiner_rgbmul_r[1], *wstate->combiner_rgbadd_r[1]);
        wstate->combined_color.g =
            color_combiner_equation(*wstate->combiner_rgbsub_a_g[1], *wstate->combiner_rgbsub_b_g[1],
                                    *wstate->combiner_rgbmul_g[1], *wstate->combiner_rgbadd_g[1]);
        wstate->combined_color.b =
            color_combiner_equation(*wstate->combiner_rgbsub_a_b[1], *wstate->combiner_rgbsub_b_b[1],
                                    *wstate->combiner_rgbmul_b[1], *wstate->combiner_rgbadd_b[1]);
    } else {
    ...
    if (wstate->combiner_alphamul[1] != &zero_color)
        wstate->combined_color.a =
            alpha_combiner_equation(*wstate->combiner_alphasub_a[1], *wstate->combiner_alphasub_b[1],
                                    *wstate->combiner_alphamul[1], *wstate->combiner_alphaadd[1]);
    else
...
combiner_2cycle_cycle0(struct rdp_state *wstate, int adseed, uint32_t cvg, uint32_t *acalpha)
{
    if (wstate->combiner_rgbmul_r[0] != &zero_color) {
        wstate->combined_color.r =
            color_combiner_equation(*wstate->combiner_rgbsub_a_r[0], *wstate->combiner_rgbsub_b_r[0],
                                    *wstate->combiner_rgbmul_r[0], *wstate->combiner_rgbadd_r[0]);
        wstate->combined_color.g =
            color_combiner_equation(*wstate->combiner_rgbsub_a_g[0], *wstate->combiner_rgbsub_b_g[0],
                                    *wstate->combiner_rgbmul_g[0], *wstate->combiner_rgbadd_g[0]);
        wstate->combined_color.b =
            color_combiner_equation(*wstate->combiner_rgbsub_a_b[0], *wstate->combiner_rgbsub_b_b[0],
                                    *wstate->combiner_rgbmul_b[0], *wstate->combiner_rgbadd_b[0]);
    } else {
    ...
    if (wstate->combiner_alphamul[0] != &zero_color)
        wstate->combined_color.a =
            alpha_combiner_equation(*wstate->combiner_alphasub_a[0], *wstate->combiner_alphasub_b[0],
                                    *wstate->combiner_alphamul[0], *wstate->combiner_alphaadd[0]);
    else
...
static STRICTINLINE void
combiner_2cycle_cycle1(struct rdp_state *wstate, int adseed, uint32_t *curpixel_cvg)
{
    int32_t keyalpha = 0, temp = 0;
    struct color chromabypass = { 0 };
