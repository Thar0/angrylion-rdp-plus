...
static void
config_dialog_update_vi_mode(void)
{
...
static void
config_dialog_fill_combo(HWND dialog, char **entries, size_t num_entries, uint32_t selected)
{
...
static void
config_handle(const char *key, const char *value, const char *section)
{
...
static void
config_write_section(FILE *fp, const char *section)
{
    fprintf(fp, "[%s]\n", section);
}

static void
config_write_uint32(FILE *fp, const char *key, uint32_t value)
{
    fprintf(fp, "%s=%u\n", key, value);
}

static void
config_write_int32(FILE *fp, const char *key, int32_t value)
{
    fprintf(fp, "%s=%d\n", key, value);
}
